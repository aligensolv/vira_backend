...
exports.createAdvancedNotFoundMiddleware = exports.RouteTracker = exports.notFoundMiddleware = void 0;
/**
 ...
 */
const findSimilarEndpoints = (requestedPath, availableEndpoints) => {
 ...
 * ```
 */
const notFoundMiddleware = (options = {}) => {
    const { logger, message = 'The requested resource was not found', includeRequestInfo = true, suggestAlternatives = true, trackMetrics = true, customResponse, excludePaths = [], includeCORS = true } = options;
...
class RouteTracker {
     ...
     */
    findSimilarRoutes(method, requestedPath) {
 ...
 */
const createAdvancedNotFoundMiddleware = (routeTracker, options = {}) => {
    return (0, exports.notFoundMiddleware)({
        ...options,
        suggestAlternatives: true,
...
exports.createAdvancedNotFoundMiddleware = createAdvancedNotFoundMiddleware;
